    ...
    app.put('/:db/:doc_id/:attachment_file_name', function(req, res) {
        ...
        var on_file_closed = function on_file_closed() {
            ...
            var on_db_retrieved = function on_db_retrieved( err, db ) { 
                ...
                db.attach( doc_id, rev, attachment_file_name, tmp_file_name, on_attached );    
            };
    ...
    app.put('/:db/:doc_id', function(req, res) {
        ...
        var on_db_retrieved = function on_db_retrieved( err, db ) { 
            ...
            if ( attachment ) {            
                ...
                //TODO multipart form support
                var on_attachment_stream_ready = function on_attachment_stream_ready( err, attachment_stream ) {
                ...
                db.attach( doc_id, rev, attachment, on_attachment_stream_ready, on_attached );

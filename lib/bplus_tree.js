 ...
 */ 
 BPlusTree.prototype.insert = function insert( key, value, on_inserted ) {
     ...
     //TODO calling processNextTick this way leads to a performance patholog during bulk inserts, this can be
     //be fixed by adding to a request queue constantly but only checking it once an insert completes
	 ...
	 var on_insert_appended = function on_insert_appended( err, page_number, node ) {
	 ...
	 this.insert_append( this.root_page_number, key, value, on_insert_appended )
     }
